...
bool LoadingLayer::init()
{
	...
	// 加载音效
	SimpleAudioEngine::getInstance()->preloadEffect("sounds/swooshing.wav");
	SimpleAudioEngine::getInstance()->preloadEffect("sounds/fly.wav");
	SimpleAudioEngine::getInstance()->preloadEffect("sounds/hit.wav");
